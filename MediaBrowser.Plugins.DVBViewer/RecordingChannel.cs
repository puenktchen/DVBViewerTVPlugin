    ...
    public class RecordingsChannel : IChannel, IHasCacheKey, ISupportsDelete, ISupportsLatestMedia, ISupportsMediaProbe, IHasFolderAttributes
    {
        ...
        public Task<DynamicImageResponse> GetChannelImage(ImageType type, CancellationToken cancellationToken)
        {
            if (type == ImageType.Primary)
            {
                ...
                {
                    Path = ChannelFolderImage("DVBViewer"),
        ...
        private DVBViewerTvService GetService()
        {
            return _liveTvManager.Services.OfType<DVBViewerTvService>().First();
        }
        ...
        private String ChannelFolderImage(string name)
        {
            ...
            _imageStream = _assembly.GetManifestResourceStream("MediaBrowser.Plugins.DVBViewer.Images." + name + "-thumb.png");
